...
# Normalize/patch: replace deprecated or unknown codes, match Django's expected codes
_REPLACEMENTS = {
    "fr-fr": "fr",
    "fr_fr": "fr",
    "tl": "fil",          # Tagalog -> Filipino (Django uses 'fil')
    "sr_latn": "sr-latn", # normalize underscore form
    "sr-latn": "sr-latn", # idempotent
    "zh_hans": "zh-hans", # normalize underscore form
    "zh-hans": "zh-hans", # idempotent
    "zh_hant": "zh-hant",
    "zh-hant": "zh-hant",
}
